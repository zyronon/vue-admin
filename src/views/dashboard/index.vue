            ...
            <el-col :sm="24" :lg="6">
                <el-card shadow="hover" class="todo-wrap">
                    <div slot="header" class="todo-header">
                        ...
                        <div class="enterTodo">
                            <el-input @keyup.enter.native="addTasks" v-model="newTasks"
                                      placeholder="need to do"></el-input>
                        </div>
                    </div>
                    <div class="todo-list">
                        <div v-for="(todo, index) in todolist" :key="index">
                            <el-checkbox v-model="todo.state" :class="todo.state ? 'deleteline' : ''">{{todo.task}}
                            </el-checkbox>
                        </div>
                    </div>
                </el-card>
                    ...
                    <div class="report-content">
                        ...
                        <el-row :gutter="24">
                            <el-col :span="24" class="progress-wrap">
                                <el-progress :width="120" type="circle" :percentage="100" status="success"
                                             color="#41b883"></el-progress>
                                <el-progress :width="120" type="circle" :percentage="80" color="#4b79bb"></el-progress>
                                <el-progress :width="120" type="circle" :percentage="50" status="exception"
                                             color="#e45f5f"></el-progress>
                                <el-progress :width="120" type="circle" :percentage="62" status="exception"
                                             color="#e45f5f"></el-progress>
                                <el-progress :width="120" type="circle" :percentage="83" status="exception"
                                             color="#e45f5f"></el-progress>
                            </el-col>
                        </el-row>
                        <el-alert
